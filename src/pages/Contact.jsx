      ...
      <section style={{ background: 'var(--bg-secondary)', padding: '60px 0' }}>
        <div className="container">
          <div className="row gy-4 justify-content-center">
            {[
              { icon: <FaWhatsapp />, title: 'WhatsApp', info: '+91 98765 43210', sub: 'Instant response', color: '#25d366', href: 'https://wa.me/919876543210' },
              { icon: <FaPhone />, title: 'Call Us', info: '+91 98765 43210', sub: 'Mon–Sun 9am–7pm', color: '#ff6b2b', href: 'tel:+919876543210' },
